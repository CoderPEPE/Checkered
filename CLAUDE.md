...
93 nodes, 100 edges, 9 key modules (+27 small)

- **testBackendTournaments()**: fail(), main(), ok(), skip(), testBackendHealth()
- **fetchLeagueSeasonSessions()**: fetchLeagueSeasonSessions(), fetchMemberInfo(), fetchRecentRaces(), fetchSubsessionResults(), iRacingAuth()
- **createTournamentFixture()**: createTournamentFixture(), deployFixture(), fullTournamentFixture(), stuckTournamentFixture()
- **formatTokenAmount() (TournamentDetail)**: fmt(), formatDate(), formatTokenAmount(), sendAdminTx()
- **mockTournamentData()**: buildApp(), mockContract(), mockTournamentData()
- **generateMockResults()**: generateMockResults(), pollTournaments(), submitResults()
- **refreshSelectedTournament()**: refreshSelectedTournament(), selectTournament()
- **handleRegisterClick()**: handleRegisterClick(), handleStatus()
- **hasFunction()**: hasEvent(), hasFunction()

God nodes: ok() (10), fail() (10), main() (10), iRacingFetch() (6), skip() (5)
<!-- END AUTO-GENERATED -->
